...
//    qDebug("MplayerProcess::parseLine: '%s'", ba.data() );
    ...
    //kobe  有些clip_name  clip_author存在乱码，所以需要在此处处理一下
    QTextCodec *str = QTextCodec::codecForName("GBK");
    QString line = ColorUtils::stripColorsTags(str->toUnicode(ba));
//    qDebug() << "AAAMplayerProcess::line:" << line;
...
//        qDebug("AAAA %s", line);
		...
		// Parse other things
//        qDebug("========MplayerProcess::parseLine: '%s'", line.toUtf8().data() );//'*** screenshot '/home/lixiang/鍥剧墖/kylin_video_screenshots/shot0006.png' ***'

        //kobe Screenshot


        //MPV:
        //Debug: MPVProcess::parseLine: 'kobe test:Screenshot: '/home/lixiang/图片/smplayer_screenshots/cap_东成西就_00:00:03_01.jpg''
        //Debug: MPVProcess::parseLine: 'kobe test:Screenshot: '/home/lixiang/图片/smplayer_screenshots/cap_东成西就_00:01:08_01.png''

        //Mplayer
        //Debug: MplayerProcess::parseLine: screenshot: '/home/lixiang/图片/smplayer_screenshots/shot0001.png'
        //Debug: Core::displayScreenshotName: /home/lixiang/图片/smplayer_screenshots/shot0001.png



        if (rx_screenshot.indexIn(line) > -1) {
			QString shot = rx_screenshot.cap(1);
//            qDebug("MplayerProcess::parseLine: screenshot: '%s'", shot.toUtf8().data());//'/home/lixiang/鍥剧墖/kylin_video_screenshots/shot0006.png'
...
//            QString tmpQStr = tc->toUnicode(ba);
//            qDebug() << "AAAMplayerProcess::tmpQStr:" << tmpQStr;
//            qDebug() << "AAAMplayerProcess::parseLine:" << line;
			QString s = rx_clip_name.cap(2).trimmed();
//            qDebug("AAA===================MplayerProcess::parseLine: clip_name: '%s'", s.toUtf8().data());
            md.clip_name = s;
		}
		else
...
//            qDebug("AAA===================MplayerProcess::parseLine: clip_artist: '%s'", s.toUtf8().data());
			md.clip_artist = s;
		}
		else
...
//            qDebug("AAA===================MplayerProcess::parseLine: clip_author: '%s'", s.toUtf8().data());
            md.clip_author = s;
		}
		else
