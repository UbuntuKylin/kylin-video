...
bool TimeDialog::eventFilter( QObject * object, QEvent * event ) {
    ...
    if (type == QEvent::MouseButtonRelease) {
        if (drag_state != TDDRAGGING || mouseEvent->button() != Qt::LeftButton) {
            drag_state = NOT_TDDRAGGING;
            return false;
        }
